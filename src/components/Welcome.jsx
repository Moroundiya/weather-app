...
function Welcome() {
    ...
    let isLoading = <div role="status" className="h-full w-full flex justify-center items-center">
    ...
    useEffect(() => {
        ...
        // console.log("new geo is " + JSON.stringify(geo))
        // console.log('after effect nextpage is ' + nextpage)
